...
/// simulation sync
/// </summary>
public class packet_LoadingProgress : UnityEngine.ScriptableObject, DFNetwork.Networking.PacketHandling.iPacketHandler {
	...
	/// </value>
	public string CommandName { get { return "LoadingProgress"; } }
	...
	public byte[] Serialize (params object[] param)
	{
		...
		if (param.Length == 0 || !(param[0] is float)) {
			throw new System.InvalidCastException("This module requires a float sent as param[0]");
		}
		
		DFNetwork.Helpers.Serializer serialize = new DFNetwork.Helpers.Serializer();
		
		serialize.AddBits( ((float)param[0]) );
	...
	public object[] Deserialize (byte[] data)
	{
		...
		ret[0] = deserialize.ReadNextFloat();
