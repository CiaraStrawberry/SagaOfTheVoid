...
/// simulation sync
/// </summary>
public class packet_Ready : UnityEngine.ScriptableObject, DFNetwork.Networking.PacketHandling.iPacketHandler {
	...
	/// </value>
	public string CommandName { get { return "Ready"; } }
	...
	public byte[] Serialize (params object[] param)
	{
		...
		if (param.Length == 0 || !(param[0] is bool)) {
		...
		serialize.AddBits( ((bool)param[0]) );
	...
	public object[] Deserialize (byte[] data)
	{
		...
		ret[0] = deserialize.ReadNextBool();
