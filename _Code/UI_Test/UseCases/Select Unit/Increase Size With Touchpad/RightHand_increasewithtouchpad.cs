...
public class RightHand_increasewithtouchpad : MonoBehaviour {
    ...
    void downon ()
    {
        ConeSmall.transform.localScale = new Vector3(1 + touchpadamount, 1 + touchpadamount , 1 + touchpadamount);
    }
